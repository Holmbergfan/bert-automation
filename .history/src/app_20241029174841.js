...
const BOT_API_PORT = process.env.BOT_API_PORT || 3000;
...
mongoose.connect(MONGODB_URI, {
  useNewUrlParser: true,       // Helps prevent warnings for the old connection string
  useUnifiedTopology: true,    // Opt in to using MongoDB's new engine
  serverSelectionTimeoutMS: 30000, // Timeout option
})
