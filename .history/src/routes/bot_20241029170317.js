...
const botController = require('../controllers/botController'); // Adjust the path as necessary to point to your controller
...
router.post('/settings', botController.updateSettings); // This route handles updating bot settings
